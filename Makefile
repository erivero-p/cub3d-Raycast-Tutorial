...
#    Updated: 2023/11/23 13:55:44 by marirodr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC			=	example.c \
#con la linea de abajo le añadimos primero la extension .c a los archivos, le añadimos la ruta de la carpeta donde se encuentra y llamamos a ssu variable correspondiente
